...
public class CustomerMobilePhoneField implements QueryField {
    ...
    public void addToQuery(BooleanBuilder booleanBuilder, SearchCriteria searchCriteria) {
        booleanBuilder.and(predicateBuilder.getBooleanBuilder(QCustomerEntity.customerEntity.mobilePhone, searchCriteria));
    }
}
