...
public class CustomerAddressField implements QueryField {
    ...
    public void addToQuery(BooleanBuilder booleanBuilder, SearchCriteria searchCriteria) {
        booleanBuilder.and(predicateBuilder.getBooleanBuilder(QCustomerEntity.customerEntity.address, searchCriteria));
    }
}